...
export IMAGE_URL=${IMAGE_URL-rhtap-quay-quay-rhtap-quay.apps.cluster-hlsws.hlsws.sandbox9.opentlc.com/rhtap/rhtap-qe-nodejs:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/rhtap-test-organization-jk/ojq7w2aix-nodejs-gitops
